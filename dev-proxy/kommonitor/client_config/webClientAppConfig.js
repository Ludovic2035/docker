try {
  ...
  window.__env.appTitle = "KomMonitor";
  ...
  window.__env.localStoragePrefix = "kommonitor-unique-instanceName";
  ...
  */
  ...
  window.__env.apiUrl = 'http://localhost/kommonitor/api/datamanagement/';
  // Base url for Data Management API
  window.__env.basePath = 'management';

  // Processing Engine URL
  window.__env.targetUrlToProcessingEngine = 'http://localhost/kommonitor/api/processingengine/processing/';
  ...
  // Data Imporret URL
  window.__env.targetUrlToImporterService = 'http://localhost/kommonitor/api/importer/importer/';
